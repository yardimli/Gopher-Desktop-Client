...
function ParseMe(inFile)
{
	ShowMessage('Test message');
//	inFile = inFile.replacd(/\n/g,
//	str = str.replace(/(?:\r\n|\r|\n)/g, '<br />');
	
	parsed = acorn.parse(inFile, options);
	parseddata = JSON.stringify(parsed, null, compact ? null : 2); 
	
	return parseddata;
	//ShowMessage(parseddata);
}
